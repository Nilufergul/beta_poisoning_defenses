...
axes[0].plot(thresholds, precisions, label='MNIST', color='blue')
axes[0].set_title('Precision')
axes[0].set_xlabel('tau', fontsize=18)
axes[0].set_ylabel('Precision', fontsize=18)
axes[0].yaxis.set_major_formatter(mticker.FuncFormatter(format_ticks))
axes[0].legend()

axes[1].plot(thresholds, recalls, label='MNIST', color='blue')
axes[1].set_title('Recall')
axes[1].set_xlabel('tau', fontsize=18)
axes[1].set_ylabel('Recall', fontsize=18)
axes[1].yaxis.set_major_formatter(mticker.FuncFormatter(format_ticks))
axes[1].legend()

axes[2].plot(thresholds, f1_scores, label='MNIST', color='blue')
axes[2].set_title('F1-Score')
axes[2].set_xlabel('tau', fontsize=18)
axes[2].set_ylabel('F1-Score', fontsize=18)
axes[2].yaxis.set_major_formatter(mticker.FuncFormatter(format_ticks))
axes[2].legend()

axes[3].plot(thresholds, accuracies, label='MNIST', color='blue')
axes[3].set_title('Accuracy')
axes[3].set_xlabel('tau', fontsize=18)
axes[3].set_ylabel('Accuracy', fontsize=18)
axes[3].yaxis.set_major_formatter(mticker.FuncFormatter(format_ticks))
axes[3].legend()

plt.tight_layout()
plt.savefig('/Users/nilufergulciftci/desktop/poisoning/Defense4/mean_distance_graph_mnist_all_1to4.pdf')
plt.close()